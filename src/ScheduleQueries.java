...
public class ScheduleQueries {
    ...
    public static ArrayList<ScheduleEntry> getWaitlistedStudentsByCourse(String semester, String courseCode)
    {
        ...
        try
        {
            getScheduleByStudent = connection.prepareStatement("SELECT studentid, timestamp FROM app.schedule WHERE semester = ? AND courseCode = ? AND status = ? ORDER BY timestamp ASC");
            getScheduleByStudent.setString(1, semester);
            getScheduleByStudent.setString(2, courseCode);
